...
export const settingsFormFields: Array<SettingsFormField> = [
  ...
  {
    id: "8c8bef37-5f12-47ed-b559-9b72987a0732",
    label: "Subnet",
    placeholder: "192.168.100.0/24",
    name: "subnet",
    defaultValue: defaultSettingsLocalStorage.subnet,
    category: "Networking" as Category,
    categorySlug: "networking" as CategorySlug,
  },
  {
  ...
  {
    id: "df956365-442d-4bea-8ba3-ffda60cc089c",
    label: "Gateway: IP address",
    placeholder: "192.168.100.1",
    name: "gatewayIpAddress",
    defaultValue: defaultSettingsLocalStorage.gatewayIpAddress,
    category: "Networking" as Category,
    categorySlug: "networking" as CategorySlug,
  },
  {
    id: "6d329dee-5c49-4774-bcf4-5be990c11877",
    label: "Base sub-domain",
    placeholder: "lan.example.com",
    name: "baseSubDomain",
    defaultValue: defaultSettingsLocalStorage.baseSubDomain,
    category: "Networking" as Category,
    categorySlug: "networking" as CategorySlug,
  },
  {

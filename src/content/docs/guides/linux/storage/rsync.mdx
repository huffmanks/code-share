...
lastUpdated: 2025-12-20 21:34:25
---
...
2.  ### Basic sync
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av {{RSYNC_LOCAL_PATH_VAR}} {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}}`}
    />
...
3.  ### Sync with compression and progress
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -avzP {{RSYNC_LOCAL_PATH_VAR}} {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}}`}
    />
...
4.  ### Delete extraneous files
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av --delete {{RSYNC_LOCAL_PATH_VAR}} {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}}`}
    />
...
1.  ### Pull files
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}} {{RSYNC_LOCAL_PATH_VAR}}`}
    />
...
2.  ### Custom SSH port
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av -e 'ssh -p 2222' {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}} {{RSYNC_LOCAL_PATH_VAR}}`}
    />
...
1.  ### Dry run
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av --dry-run {{RSYNC_LOCAL_PATH_VAR}} {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}}`}
    />
...
2.  ### Exclude files
    ...
    <Code
      lang="sh"
      wrap
      code={`rsync -av --exclude '{{PATTERN_VAR}}' {{RSYNC_LOCAL_PATH_VAR}} {{USERNAME_VAR}}@{{SERVER_IP_VAR}}:{{RSYNC_REMOTE_PATH_VAR}}`}
    />

...
import yaml from "/src/files/compose/dns-proxy.yml?raw";
...
5.  ## AdGuard Home
        ...
        - **Allowed clients:**
            ...
            - **Device IP range:** `192.168.100.0/24`.
...
7.  ## Tailscale admin console

        - Go to <a class="link" href="https://login.tailscale.com" target="_blank" rel="noopener">https://login.tailscale.com</a>.

...
lastUpdated: 2025-12-28 20:28:55
tableOfContents:
  maxHeadingLevel: 5
references:
...
import {
  ...
  serverIp,
  virtualIp,
} from "@/lib/mdx-constants";
import { Code, Steps, TabItem, Tabs } from "@astrojs/starlight/components";
import composeYml from "/src/files/compose/remote-local-access.yml?raw";
import composeWithSyncYml from "/src/files/compose/remote-local-access_sync.yml?raw";
...
4.  ## AdGuard Home
        ...
        5. ### Filters (optional)
                ...
                - Go to Filters > **Custom filtering rules**.
                        ...
                        @@||log.tailscale.io^
                        ```
                        - Add **Tailscale domains** to allow.
                        - Click `Apply`.

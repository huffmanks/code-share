---
title: macOS
description: This guide walks you through setting up macOS to configure native settings and preinstall essential apps and configurations.
prev: false
next: false
---
...
- Allow notifications when the screen is locked > <mark>false</mark>
...
- When Switching User > Login window shows > <mark>Name and password</mark>

### Trackpad

- Secondary click > <mark>Click in Bottom Right Corner</mark>
...
- Group By: <mark>None</mark>
- Sort By: <mark>Date Modified</mark>

...
lastUpdated: 2025-07-26 16:40:50
references:
...
import { daemonJson, debianAptSource, ubuntuAptSource, verifyDockerData } from "@/lib/mdx-constants";
...
3. #### Add Docker GPG key
   ...
   <Code
     ...
     wrap
     preserveIndent
     code={`sudo curl -fsSL https://download.docker.com/linux/debian/gpg -o /etc/apt/keyrings/docker.asc`}
   />
...
2. #### Modify user permissions
   ...
   Modify user permissions to ensure they have the necessary access rights to interact with Docker.
